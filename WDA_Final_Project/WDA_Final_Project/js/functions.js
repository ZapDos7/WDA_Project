( function( $ ) {
	...
	$( document ).ready(function() {
			...
			//........................navigation bar..............................
			jQuery(".navbar-nav").on('click', '.nav_li', function(){
				jQuery(".nav_li").removeClass("activation");
				jQuery(this).addClass("activation");
			});


			//navbar-toggle
			jQuery(".navbar-header").on('click', '.navbar-toggle', function(){
				var nav_status=jQuery("#nav_menu").attr('class').split(' ')[2];
				if(nav_status=="show_nav"){
				jQuery(".navbar-nav").removeClass("show_nav");
				}else{
				jQuery(".navbar-nav").addClass("show_nav");	
				}
